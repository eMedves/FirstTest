...
import org.spagic3.databaseManager.activator.DatabaseComponentActivator;
...
public class OSGiDataSourceConnectionProvider implements ConnectionProvider {
	...
	public void configure(Properties props) throws HibernateException {
		...
		try {
			...
			ds = (DataSource) DatabaseComponentActivator.getDataSourceManager().getDataSource(realDatasourceId);
		}
		catch (Exception e) {
