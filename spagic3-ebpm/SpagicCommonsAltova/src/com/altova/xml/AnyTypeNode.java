...
public class AnyTypeNode extends Node {
	...
	public org.w3c.dom.Node getFirstChildElement(String namespaceURI, String name ) {
		return getDomFirstChild(com.altova.xml.Node.Element,  namespaceURI, name );
	}
	
	public org.w3c.dom.Node getNextChildElement(String namespaceURI, String name, org.w3c.dom.Node childNode ) {
		return getDomNextChild(com.altova.xml.Node.Element, namespaceURI, name, childNode);
	}
	
	public void appendChildElement(String namespaceURI, String name, com.altova.xml.Node node) throws Exception {
	...
	public org.w3c.dom.Node appendChildElement(String namespaceURI, String name, String value) {
		return appendDomChild(com.altova.xml.Node.Element, namespaceURI, name, value);
	}
