...
public abstract class Node implements java.io.Serializable {
	...
	public void assign(com.altova.xml.Node other)
	{
	...
	protected org.w3c.dom.Node insertDomElementAt(String namespaceURI, String name, int index, com.altova.xml.Node srcNode) {
	...
	protected org.w3c.dom.Node replaceDomElementAt(String namespaceURI, String name, int index, com.altova.xml.Node srcNode) {
	...
	protected org.w3c.dom.Node appendDomElement(String namespaceURI, String name, com.altova.xml.Node srcNode) {
		srcNode.domNode = domNode.appendChild(cloneDomElementAs(namespaceURI, name, srcNode));
		return srcNode.domNode;
	}

	protected org.w3c.dom.Element cloneDomElementAs(String namespaceURI, String name, com.altova.xml.Node srcNode) {
