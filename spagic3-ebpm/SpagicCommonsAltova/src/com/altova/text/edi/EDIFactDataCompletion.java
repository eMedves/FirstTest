...
public class EDIFactDataCompletion extends DataCompletion {
		...
		public void completeData(TextNode dataroot, Particle rootParticle) {
		...
		protected void completeInterchange(ITextNode interchange) {
			...
			if (unb == null && unz == null)
				MakeSureHasChild.asFirst(interchange, "Group");
			else
			{
				unb = MakeSureHasChild.asFirst(interchange, "UNB");
				MakeSureHasChild.at(interchange, "Group", 1);
				unz = MakeSureHasChild.asLast(interchange, "UNZ");
			}
		...
		protected void completeS002(ITextNode s002) {
			ITextNode f0004 = MakeSureHasChild.at(s002, "F0004", 0);
			conservativeSetValue(f0004, "Sender");
		}
		
		protected void completeS003(ITextNode s003) {
			ITextNode f0010 = MakeSureHasChild.at(s003, "F0010", 0);
