...
public class Lang {
  ...
  */
  public static SchemaTypeNumber countSubstring(SchemaString string, SchemaString substr ) {
    ...
    for ( int i = 0; i <= string.getValue().length(); ++i )
        if ( string.getValue().startsWith(substr.getValue(), i) )
            nResult ++;
  ...
  */
  public static SchemaDateTime datetimeAdd(SchemaDateTime datetime, SchemaDuration duration ) {
    ...
    long tv = result.getTimeValue() + duration.getDayTimeValue() + result.getTimezoneOffset() * 60000;
  ...
  */
  public static SchemaTypeNumber dayFromDuration(SchemaDuration value ) {
    return new SchemaInt( value.isNegative() ? -value.getDay() : value.getDay() );
  }
  ...
  */
  public static SchemaTypeNumber millisecondFromDuration(SchemaDuration value ) {
    return new SchemaInt( value.isNegative() ? -value.getMillisecond() : value.getMillisecond() );
  }
  ...
  */
   ...
   */
  public static SchemaTypeNumber autoNumber( AutoNumberState state, SchemaTypeNumber startAt, SchemaTypeNumber increase ) {
    if (!state.isInitialized())
          state.init(startAt.intValue(), increase.intValue());
