...
public class JBFCaller {
	...
	public JBFCaller(String spagicUri, boolean balanced) {
		this(spagicUri, balanced, false);
	}

	public JBFCaller(Properties properties, boolean balanced) {
		this(properties, balanced, false);
	}

	public JBFCaller(Properties properties, boolean balanced, boolean ignoreFaultStrings) {
		this.properties = properties;
		this.balanced = balanced;
		this.ignoreFaultStrings = ignoreFaultStrings;
	}

	public JBFCaller(String spagicUri, boolean balanced, boolean ignoreFaultStrings) {
	...
	public boolean handleError(int code, JBFHelper helper, ProcessContext pc, Exchange exchange,
