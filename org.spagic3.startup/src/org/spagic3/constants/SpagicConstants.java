...
public class SpagicConstants {
	...
	public static final String  _INTERNAL_EVENT_PROCESS_STARTED = "_INTERNAL_EVENT_PROCESS_STARTED";
	public static final String  _INTERNAL_EVENT_PROCESS_ID = "_INTERNAL_EVENT_PROCESS_ID";
