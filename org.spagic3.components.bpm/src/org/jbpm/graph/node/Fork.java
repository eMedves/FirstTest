...
public class Fork extends Node implements Parsable {
  ...
  public void execute(ExecutionContext executionContext) {
	...
	*/
    ...
    String xmlMessage = (String)executionContext.getContextInstance().getVariable("XML_MESSAGE", executionContext.getToken());
    executionContext.getContextInstance().deleteVariable("XML_MESSAGE", executionContext.getToken());
    iter = forkedTokens.iterator();
    while( iter.hasNext() ) {
      ForkedToken forkedToken = (ForkedToken) iter.next();
      Token childToken = forkedToken.token;
      if (xmlMessage != null)
    	  executionContext.getContextInstance().setVariable("XML_MESSAGE", xmlMessage, childToken);
