...
public class BridgeServlet extends HttpServlet {
	...
	protected static BridgeServlet instance;
	private HttpServlet delegate;
	private FrameworkLauncher framework;

	private int delegateReferenceCount;
	protected boolean enableFrameworkControls;
	 ...
	 */
	protected boolean serviceFrameworkControls(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		String pathInfo = req.getPathInfo();
	...
	public FrameworkLauncher getFramework() {
		return framework;
	}

	public void setFramework(FrameworkLauncher framework) {
